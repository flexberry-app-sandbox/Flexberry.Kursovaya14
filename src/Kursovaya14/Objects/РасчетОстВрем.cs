...
namespace IIS.Kursovaya14
{
    ...
    public class РасчетОстВрем : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Kursovaya14.DetailArrayOfОказКонсульт fОказКонсульт;
        ...
        public virtual IIS.Kursovaya14.DetailArrayOfОказКонсульт ОказКонсульт
        {
            get
            {
                ...
                {
                    this.fОказКонсульт = new IIS.Kursovaya14.DetailArrayOfОказКонсульт(this);
                }
                IIS.Kursovaya14.DetailArrayOfОказКонсульт result = this.fОказКонсульт;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремE", typeof(IIS.Kursovaya14.РасчетОстВрем));
                }
            }
            ...
            public static ICSSoft.STORMNET.View РасчетОстВремL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("РасчетОстВремL", typeof(IIS.Kursovaya14.РасчетОстВрем));
                }
            }
        }
    }
